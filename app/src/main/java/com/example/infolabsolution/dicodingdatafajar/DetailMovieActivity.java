...
import com.example.infolabsolution.dicodingdatafajar.MovieHelper;
import com.example.infolabsolution.dicodingdatafajar.MovieItems;
import com.example.infolabsolution.dicodingdatafajar.DetailMovieLoader;
...
//    @BindView(R.id.img_poster) ImageView imgPoster;
    ...
    void setFab(){
        ...
        if (isFavorite) {
            Snackbar.make(fab, getString(R.string.deletesnackbar), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
            fab.setImageResource(R.drawable.ic_favorite_border_white_36dp);
        }else {
            Snackbar.make(fab, getString(R.string.successsnackbar), Snackbar.LENGTH_LONG)
                    .setAction("Action", null).show();
            fab.setImageResource(R.drawable.ic_favorite_white_36dp);
        }
    }
