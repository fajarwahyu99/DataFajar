...
import com.example.infolabsolution.dicodingdatafajar.BuildConfig;
import com.example.infolabsolution.dicodingdatafajar.DetailMovieActivity;
...
public class MovieAdapter extends RecyclerView.Adapter<MovieAdapter.MovieViewHolder> {
    ...
    public class MovieViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.detail_btn) Button btnDetail;
        @BindView(R.id.share_btn) Button btnShare;
