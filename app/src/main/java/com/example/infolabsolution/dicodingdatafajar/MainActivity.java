...
import com.example.infolabsolution.dicodingdatafajar.FavoriteFragment;
import com.example.infolabsolution.dicodingdatafajar.HomeFragment;
import com.example.infolabsolution.dicodingdatafajar.SearchMovieFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(
                this, drawer, toolbar, R.string.open_navigation_drawer, R.string.navigation_drawer_close);
        drawer.setDrawerListener(toggle);
        toggle.syncState();

        navigationView.setNavigationItemSelectedListener(this);

        activityTitles = getResources().getStringArray(R.array.nav_titleactivity);
